...
> 状態: P1完了、P2〜P5実装中(2026-07-12)。テンプレート方言メタデータ、scene bible、balloonStyle、文節折返し・縦中横、adapt/fill、決定的QA/lettering監査を実装済み。キャラシート専用run、N1ページネーム、SFX/効果線、実機画像A/Bは未完了。
