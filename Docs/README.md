...
- `Docs/` 直下(`Feature-*.md`) — 進行中の機能設計ドキュメント
...
| [Feature-AutomaticScriptManga.md](Done/Feature-AutomaticScriptManga.md) | Fountainからページ/コマ/画像/吹き出しを一括生成し、アニメ顔ランドマークで尻尾を口元へ向ける自動漫画パイプライン |
