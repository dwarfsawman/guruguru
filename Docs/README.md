...
- 2026-07-13: Anima In-Context Characterのsingle-reference PoCを追加。動的adapter/参照latent注入、family別モデル確認、隔離8288 smokeと、Reference Set化へ残す境界を`Reference-AnimaPreset.md`へ記録。
