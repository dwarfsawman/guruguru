 ...
 */
import { PAGE_OBJECT_MIN_SIZE, type BalloonObject, type BoxObject, type TextObject } from "../shared/pageObjects";
...
export function gizmoBoxForPageObject(object: BoxObject | BalloonObject | TextObject): GizmoBox {
  if (object.kind === "box" || object.kind === "balloon") {
