      ...
      <main class="studio-main">
        ...
        <div class="gallery-scroll">
          <div class="image-grid cols-${gridCols}">
            ${assets.length ? assets.map((asset) => renderAssetTile(asset, getInpaintDraft)).join("") : renderEmptyGallery(activeRound)}
          </div>
        </div>
...
export function renderAssetTile(asset: Asset, getInpaintDraft: (assetId: string) => InpaintDraft | null) {
